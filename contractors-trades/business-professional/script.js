                    ...
                    notice.innerHTML = `
                        <div style="background: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 1rem; margin-top: 1rem;">
                            <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
                                ...
                                <strong style="color: #dc2626;">Emergency Service Notice</strong>
                            </div>
                            <p style="color: #991b1b; font-size: 0.875rem; margin: 0;">
                                For life-threatening emergencies, please call 911 immediately. This form is for non-life-threatening construction emergencies only.
                            </p>
                        </div>
                    `;
