...
function handleFormSubmit(e) {
    ...
    if (validateForm()) {
        ...
        submitBtn.textContent = 'Requesting Estimate...';
        ...
        setTimeout(() => {
            ...
            showNotification('Thank you! Your estimate request has been submitted. Our project coordinator will contact you within 24 hours to discuss your project details.', 'success');
...
function initializeConstructionFeatures() {
    ...
    if (serviceSelect) {
        serviceSelect.addEventListener('change', function() {
            ...
            switch (this.value) {
                case 'general':
                    messageLabel.textContent = 'Project Description (include scope, materials, timeline) *';
                    break;
                case 'electrical':
                ...
                case 'hvac':
                    ...
                    break;
                case 'remodeling':
                    messageLabel.textContent = 'Remodeling Project Description (include rooms, changes, materials) *';
                    break;
                case 'commercial':
                    messageLabel.textContent = 'Commercial Project Description (include business type, scope, timeline) *';
                    break;
                default:
        ...
        projectTypeSelect.addEventListener('change', function() {
            ...
            if (this.value === 'emergency') {
                if (!emergencyNotice) {
                    ...
                    titleStrong.textContent = 'Emergency Service Notice';

                    const messageP = document.createElement('p');
                    messageP.style.cssText = 'color: #991b1b; font-size: 0.875rem; margin: 0;';
                    messageP.textContent = 'For life-threatening emergencies, please call 911 immediately. This form is for non-life-threatening construction emergencies only.';
...
// Construction-specific accessibility features
document.addEventListener('DOMContentLoaded', function() {
