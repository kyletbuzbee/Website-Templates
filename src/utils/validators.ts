 ...
 */
export function hasMaxLength(value: any, maxLength: any) {
  if (!value || typeof value !== 'string') {
    return true;
  } // Allow empty values
 ...
 * Range validation
 */
export function isInRange(value: any, min: any, max: any) {
  if (!isNumeric(value)) {
    return false;
  }
 ...
 */
export function isValidCreditCard(number: any) {
 ...
 */
export function isValidUSPostalCode(code: any) {
