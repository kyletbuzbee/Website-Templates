...
function validateField(field) {
    ...
    switch (fieldName) {
        ...
        case 'serviceType':
            if (!value) {
                isValid = false;
                errorMessage = 'Please select a photography service';
            }
            break;
        ...
        case 'message':
            if (!value) {
                isValid = false;
                errorMessage = 'Please describe your photography project';
...
function handleFormSubmit(e) {
    ...
    if (validateForm()) {
        ...
        submitBtn.textContent = 'Requesting Consultation...';
        ...
        setTimeout(() => {
            ...
            showNotification('Thank you! Your photography consultation request has been submitted. Our team will contact you within 24 hours to discuss your project vision.', 'success');
...
function initializePhotographyFeatures() {
    ...
    if (serviceSelect) {
        serviceSelect.addEventListener('change', function() {
            const eventDateGroup = document.querySelector('#eventDate').closest('.form-group');
            const dateLabel = eventDateGroup.querySelector('.form-label');

            // Update date field based on service type
            switch (this.value) {
                case 'event':
                    ...
                    break;
                case 'portrait':
                    dateLabel.textContent = 'Preferred Session Date';
                    eventDateInput.required = false;
                    break;
                case 'commercial':
                    dateLabel.textContent = 'Project Timeline Start Date';
                    eventDateInput.required = false;
                    break;
                default:
                    dateLabel.textContent = 'Event/Shoot Date';
                    eventDateInput.required = false;
            }
        });
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize photography-specific features
    initializePhotographyFeatures();
...
// Photography-specific accessibility features
document.addEventListener('DOMContentLoaded', function() {
    ...
    formSections.forEach((section, index) => {
        section.setAttribute('aria-labelledby', `contact-section-${index + 1}`);
    });
});
